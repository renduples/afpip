...
**Demo Users**:
```
Admin:    admin@afpi.gov    / ***REMOVED***
Analyst:  analyst@afpi.gov  / ***REMOVED***  
Viewer:   viewer@afpi.gov   / ***REMOVED***
```
...
3. Use one of the demo credentials:
   - `admin@afpi.gov` / `***REMOVED***`
   - `analyst@afpi.gov` / `***REMOVED***`
   - `viewer@afpi.gov` / `***REMOVED***`
4. Click "Sign In"
